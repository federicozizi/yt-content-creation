...
1. **Prima di scrivere**: se esiste già `briefs/_partial/pricing.md` da una run precedente, rinominalo in `briefs/_partial/pricing-previous.md` (così hai il confronto al punto 3)
2. **Poi scrivi** il nuovo `briefs/_partial/pricing.md` con i dati di oggi
3. Notifica il team che il task è completato
